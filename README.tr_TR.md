...
<p align="center">
  <a href="https://github.com/MixxxGit/3x-ui/releases"><img src="https://img.shields.io/github/v/release/MixxxGit/3x-ui" alt="Release"></a>
  <a href="https://github.com/MixxxGit/3x-ui/actions"><img src="https://img.shields.io/github/actions/workflow/status/MixxxGit/3x-ui/release.yml.svg" alt="Build"></a>
  <a href="#"><img src="https://img.shields.io/github/go-mod/go-version/MixxxGit/3x-ui.svg" alt="GO Version"></a>
  <a href="https://github.com/MixxxGit/3x-ui/releases/latest"><img src="https://img.shields.io/github/downloads/MixxxGit/3x-ui/total.svg" alt="Downloads"></a>
...
```bash
bash <(curl -Ls https://raw.githubusercontent.com/MixxxGit/3x-ui/main/install.sh)
```

Belirli bir sürümü kurmak için, etiketini (ör. `v3.4.0`) ekleyin:

```bash
bash <(curl -Ls https://raw.githubusercontent.com/MixxxGit/3x-ui/main/install.sh) v3.4.0
```
...
```bash
bash <(curl -Ls https://raw.githubusercontent.com/MixxxGit/3x-ui/main/install.sh) dev-latest
```
...
Tam dokümantasyon için lütfen [proje Wiki sayfasını](https://github.com/MixxxGit/3x-ui/wiki) ziyaret edin.
...
```bash
docker run -d --cap-add=NET_ADMIN --cap-add=NET_RAW ... ghcr.io/mixxxgit/3x-ui
```
...
[![Zaman içerisindeki yıldız sayısı](https://starchart.cc/MixxxGit/3x-ui.svg?variant=adaptive)](https://starchart.cc/MixxxGit/3x-ui)
